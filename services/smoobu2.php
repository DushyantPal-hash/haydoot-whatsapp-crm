...
<style>
    ...
    /* ── View switcher (matches integration page) ── */
    .view-switcher {
        display: inline-flex;
        background: #f1f5f9;
        border-radius: 50px;
    ...
    <section>
        <div class="container-fluid">
            ...
            <div style="margin-bottom:36px;">
                <p style="color:#6b7280;font-size:.9rem;margin-bottom:10px;">
                    <i class="fas fa-eye" style="margin-right:6px;"></i> Choose your view:
                </p>
                <div class="view-switcher" id="viewSwitcher">
                    <button class="view-tab active" data-mode="host">
                        <i class="fas fa-home"></i> Property Manager
                    </button>
                    <button class="view-tab" data-mode="dev">
                ...
                <main style="flex:2.5;min-width:280px;">
                    ...
                    <div id="compare" class="section-block">
                        ...
                        <div
                            ...
                            <!-- Growth (featured) -->
                            <div class="plan-card featured automation-card" style="overflow: visible;">
    ...
    (function () {
        ...
        switcher.querySelectorAll('.view-tab').forEach(tab => {
            tab.addEventListener('click', () => {
                switcher.querySelectorAll('.view-tab').forEach(t => t.classList.remove('active'));
