...
<head>
    ...
    <head>
        ...
        <!-- Google tag (gtag.js) -->
        <script async
            src="https://www.googletagmanager.com/gtag/js?id=<?php echo htmlspecialchars($gtag_id); ?>"></script>
        <script>
        ...
        <?php foreach ($extra_scripts as $script): ?>
            ...
            <?php elseif ($script['type'] === 'js'): ?>
                <script src="<?php echo htmlspecialchars($script['src']); ?>" <?php echo isset($script['async']) ? 'async' : ''; ?>         <?php echo isset($script['defer']) ? 'defer' : ''; ?>></script>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title><?php echo $page_title ?? SITE_NAME . ' - Manage WhatsApp Groups at Scale'; ?></title>
<meta name="description" content="Manage WhatsApp Groups at Scale for Modern Businesses">
<link rel="icon" href="<?php echo BASE_URL; ?>/assets/icons/favicon.png" type="image/png">
<link href="https://api.fontshare.com/v2/css?f[]=satoshi@300,400,500,700,900&display=swap" rel="stylesheet">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
<link rel="stylesheet" href="<?php echo BASE_URL; ?>/style.css">
